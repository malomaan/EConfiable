...
namespace EConfiableBD
{
    ...
    /// Create date: Apr 23 2020  8:54AM
    ...
    public class TipocategoriamatriculaBD
    {
        ...
        public TipocategoriamatriculaBD()
        {
            tcm_descripcion = "";
        }
        // ===========================================================================
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Apr 23 2020  8:54AM
        /// Método que permite insertar en la tabla Tipocategoriamatricula capa BD
        /// </summary>
        // ******************* = Método Insert = ******************************
        public void Tipocategoriamatricula_Insert(string tcm_descripcion)
        {
            try
            {
                BD.Tipocategoriamatricula_Insert(tcm_descripcion);
                BD.SaveChanges();
            }
            catch (Exception Ex)
            {
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Apr 23 2020  8:54AM
        /// Método que permite actualizar en la tabla Tipocategoriamatricula capa BD
        /// </summary>
        // ******************* = Método Update = ******************************
        public void Tipocategoriamatricula_Update(int tcm_id, string tcm_descripcion)
        {
            try
            {
                BD.Tipocategoriamatricula_Update(tcm_id, tcm_descripcion);
                BD.SaveChanges();
            }
            catch (Exception Ex)
            {
        ...
        /// Author     : MARCO ANTONIO MARTINEZ LOPEZ
        /// Create date: Apr 23 2020  8:54AM
        /// Método que permite eliminar en la tabla Tipocategoriamatricula capa BD
        /// </summary>
        // ******************* = Método Delete = ******************************
        public void Tipocategoriamatricula_Delete(int tcm_id)
        {
            try
            {
                BD.Tipocategoriamatricula_Delete(tcm_id);
                BD.SaveChanges();
            }
            catch (Exception Ex)
            {
        ...
        public List<Tipocategoriamatricula_List_Result> Tipocategoriamatricula_List(int tcm_id)
        {
            try
            {
                var Tipocategoriamatricula = (from TTipocategoriamatricula in BD.Tipocategoriamatricula_List(tcm_id) select TTipocategoriamatricula).ToList();
